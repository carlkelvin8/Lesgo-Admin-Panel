...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-4">
        ...
        @empty<div class="bg-white rounded-xl p-10 text-center text-gray-400"><x-empty-state icon="fa-inbox" title="No staff assigned" description="No staff assigned to this partner." /></div>@endforelse
    </div>
</div>
@endsection
